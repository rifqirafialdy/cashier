...
module.exports = {
    addProduct: async (req, res) => {
        ...
        const addProduct = await query(`INSERT INTO products VALUES (null,${db.escape(name)},${db.escape(description)},null,${db.escape(price)},false,null,${db.escape(categoryId)})`)
